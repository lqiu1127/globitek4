  ...
  if (empty($errors)) {
    ...
    if($user) {
      if($password === $master_password) {
        ...
        $errors[] = "The password does not match the username given."; // write an error message
      }
    } else {
      // No username found
      $errors[] = "The username password pair does not exist in the database."; // write an error message
    }
  }
}
